...
write.csv(y_hat, file.path(sprintf("../../data/plateaus/predictions/crisp/%d/%d.csv", N, trial)), row.names=FALSE)
...
write.csv(c(rmse, maxerr, q, lambda.seq[best.lambda]), file.path(sprintf("../../data/plateaus/results/crisp/%d/%d.csv", N, trial)), row.names=FALSE)
